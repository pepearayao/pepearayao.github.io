...
def create_connection():
        conn = psycopg2.connect(host="private-normalized-database-do-user-13317905-0.b.db.ondigitalocean.com", port="25060", user="doadmin", password="AVNS_xgvCO2l8Cu1PATzQCil", dbname="entremed_remoto")
        return conn 
...
cur.execute("DROP TABLE IF EXISTS urls CASCADE;\
            ...
            (205, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=enfermeria&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
            (206, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=enfermera&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(207, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=enfermero&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(208, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=tens&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(209, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=tecnico%20en%20enfermeria&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(210, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=odontologo&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(211, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=odontologa&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(212, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=odongologia&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(213, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=kinesiologo&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(214, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=kinesiologa&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(215, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=kinesiologia&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(216, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=fonoaudiologia&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(217, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=fonoaudiologa&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(218, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=fonoaudiologo&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(219, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=psicologo%20en%20enfermeria&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(220, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=psicologa&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(221, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=psicologia&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(222, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=tecnologo%20medico&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(223, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=matrona&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(224, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=matron&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(225, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=nutricionista&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(226, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=paramedico&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(227, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=psicopedagogia&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(228, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=fonoaudiologo&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7),\
			(229, 'https://www.bne.cl/ofertas?mostrar=empleo&textoLibre=psicologo%20en%20enfermeria&numPaginaRecuperar=1&numPaginasTotal=19&numResultadosPorPagina=10&numResultadosTotal=185&clasificarYPaginar=true&totalOfertasActivas=5918',7);\
            ")
conn.commit()
...
cur.execute("DROP TABLE IF EXISTS push_services CASCADE;\
            ...
            INSERT INTO push_services (push_service_id, push_service_name)\
            VALUES \
            (1,'WhatsApp'),\
            (2,'Firebase'),\
            (3,'OneSignal'),\
...
cur.execute("DROP TABLE IF EXISTS channels CASCADE;\
            ...
            short_channel_link varchar NOT NULL,\
            push_service_id int NOT NULL,\
            specialty_id int NOT NULL,\
            PRIMARY KEY (channel_id),\
            FOREIGN KEY (push_service_id) REFERENCES push_services (push_service_id),\
            FOREIGN KEY (specialty_id) REFERENCES specialties (specialty_id));\
            INSERT INTO channels (channel_link, short_channel_link, push_service_id, specialty_id)\
            VALUES \
            ('L6K22OaMgtrD6E9Iqm6ZBq','https://bit.ly/44l2H4I',1,1),\
            ('ByGZwqx4bXRDQwneb2GCxb','https://bit.ly/3Vq7GNw',1,2),\
            ('HrQU00A2WPcITz2nsMgjem','',1,3),\
            ('EukRBYGTZR1C9aqy5nkmPO','',1,4),\
            ('LrrqH5vsFmh3k2dyaBIdUr','https://bit.ly/3LLcrOs',1,5),\
            ('D7XopiLrWV0B5hcvYRomPn','',1,6),\
            ('HdSyo8CqU1gHCOy6VTY1VJ','',1,7),\
            ('IxcUsoRDt6Z4oh170D74k0','',1,8),\
            ('L4o5PgTbTpf0tH8Nc2itci','https://bit.ly/3Ns0u1e',1,9),\
            ('HDoCh95yN4V2ZgsF3CE3yq','',1,10),\
            ('JaxeX0TIZsNDmVvs9rDlQn','',1,11),\
            ('-1001940935365','',10,1),\
            ('-1001967531560','',10,2),\
            ('-1001862425894','',10,3),\
            ('-1001884130361','',10,4),\
...
#create table pushes
cur.execute("CREATE TABLE IF NOT EXISTS push_notifications (\
            normalized_job_offer_id int NOT NULL,\
            channel_id int NOT NULL,\
            time_to_push timestamp NOT NULL,\
            push_status_id int NOT NULL,\
            PRIMARY KEY (normalized_job_offer_id, channel_id),\
